...
```{r}
influencePlot(lm_log1,id=list(method="identify"),main="Influence Plot", sub="Circle size is proportional to Cook's distance")
```
...
```{r}
plot(hatvalues(lm_step), rstandard(lm_step),xlab='Leverage', ylab='Standardized Residuals')
```
